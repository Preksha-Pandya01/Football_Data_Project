create or replace table intermediate_schema.int_children_team (
parent_team_id integer,
parent_team_name text,
child_team_id integer primary key,
...
create or replace procedure intermediate_Schema.int_children_team_proc ()
RETURNS VARCHAR
language SQL
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 1,  "minor": 17,  "patch": "6.0" }, "attributes": {  "component": "postgresql",  "convertedOn": "09-18-2025",  "domain": "inferenz" }}'
as $$
...
select * from intermediate_schema.int_children_team c
join int_team_competitions_seasons t on
c.child_team_id=t.team_id;